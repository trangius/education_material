// Många har stött på Lambda-uttryck när ni har sökt genom listor
// med hjälp av LINQ. Här är ett exempel på hur det brukar se ut:
class Program
{
    static void Main(string[] args)
    {
        ...
        // Sök efter alla böcker skrivna av Tolkien med hjälp av LINQ och lambda-uttryck
