// Och nu samma men med en helt vanlig metod
class Program
{
    static void Main(string[] args)
    {
        ...
        // Sök efter alla böcker skrivna av Tolkien med hjälp av LINQ och en vanlig funktion
        var tolkienBooks = books.Where(IsTolkienBook).ToList();
